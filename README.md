...
display: inline does not add a line-break after the element, so the element can sit next to other elements.
Inline flows along with content and will not clear previous content to drop to the next line like block elements.
